...
class Net(nn.Module):
    def __init__(self):
        ...
        self.fc1 = nn.Linear(16 * 91 * 91, 120)
...
if __name__ == '__main__':
    ...
    path_img = os.path.join(BASE_DIR,  "Data", "cam_img", "cat1.jpg")
    ...
    # 保存cam图片
    img_show = np.float32(cv2.resize(img, (376, 376))) / 255
